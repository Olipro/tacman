module NetworkObjectGroupsHelper
    ...
    def nog_description(network_object_group, show_details=false)
        ...
        return("<ul style=\"list-style-type: none;\"><li>network-object-group #{network_object_group.name}</li><li><i> &nbsp&nbsp empty set</i></li></ul>") if (entries.length == 0)

        str = "<ul style=\"list-style-type: none;\">\n"
        str << "<li>network-object-group #{network_object_group.name}</li>\n"
        entries.each do |e|
            str << "<li> &nbsp&nbsp "
